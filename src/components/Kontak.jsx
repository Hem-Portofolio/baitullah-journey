            ...
            <form className="space-y-5 md:space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                <div className="space-y-2">
                  ...
                  <input className="w-full border-b border-on-surface/20 bg-transparent py-3 focus:outline-none focus:border-secondary transition-colors duration-200" placeholder="Masukkan nama Anda" type="text" />
                </div>
                <div className="space-y-2">
                  <label className="font-label-lg text-primary">Nomor WhatsApp</label>
                  <input className="w-full border-b border-on-surface/20 bg-transparent py-3 focus:outline-none focus:border-secondary transition-colors duration-200" placeholder="0812-xxxx-xxxx" type="tel" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="font-label-lg text-primary">Pilihan Paket</label>
                <select className="w-full border-b border-on-surface/20 bg-transparent py-3 focus:outline-none focus:border-secondary transition-colors duration-200">
              ...
              <div className="space-y-2">
                ...
                <textarea className="w-full border-b border-on-surface/20 bg-transparent py-3 focus:outline-none focus:border-secondary transition-colors duration-200" placeholder="Tuliskan pertanyaan Anda..." rows="3" />
              </div>
              <button className="bg-primary text-on-primary px-8 py-4 rounded-xl font-label-lg hover:bg-primary/90 transition-all duration-200 active:scale-[0.97] shadow-lg hover:shadow-xl">Kirim Pesan</button>
            </form>
          </div>
          <div data-animate className={`bg-secondary-fixed p-8 md:p-12 rounded-3xl space-y-6 md:space-y-8 text-center lg:text-left ${inView ? 'in-view' : ''}`} style={{ transitionDelay: '0.3s' }}>
            ...
            <a
              href="https://wa.me/#"
              className="inline-flex items-center gap-3 md:gap-4 bg-primary text-on-primary px-8 md:px-10 py-4 md:py-5 rounded-2xl font-headline-md text-lg md:text-xl hover:scale-105 transition-transform duration-200 luxury-shadow"
            >
